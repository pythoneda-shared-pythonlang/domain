  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        pythoneda-base-0_0_1a14-for = python:
          pythoneda-base-for {
            version = "0.0.1a14";
            inherit python;
          };
      in rec {
        packages = rec {
          pythoneda-base-0_0_1a14-python38 =
            pythoneda-base-0_0_1a14-for pkgs.python38;
          pythoneda-base-0_0_1a14-python39 =
            pythoneda-base-0_0_1a14-for pkgs.python39;
          pythoneda-base-0_0_1a14-python310 =
            pythoneda-base-0_0_1a14-for pkgs.python310;
          pythoneda-base-0_0_1a14-python311 =
            pythoneda-base-0_0_1a14-for pkgs.python311;
          pythoneda-base-latest-python38 = pythoneda-base-0_0_1a14-python38;
          pythoneda-base-latest-python39 = pythoneda-base-0_0_1a14-python39;
          pythoneda-base-latest-python310 = pythoneda-base-0_0_1a14-python310;
          pythoneda-base-latest-python311 = pythoneda-base-0_0_1a14-python311;
